...
```{r load}
ROI_global <- 
  readRDS("/Users/colinccm/Documents/GitHub/Peres/IF_case_ctrl_AACES_NCOCS/cat_long_format_markers_clinical_ROI_07132023.rds")
markers_ROI <- 
  readRDS("/Users/colinccm/Documents/GitHub/Peres/IF_case_ctrl_AACES_NCOCS/cat_summarized_markers_clinical_ROI_07132023.rds")
...
I removed 4 patients who don't have intratumoral ROI in the new AACES data
```{r remove patients}
...
# write_rds(b, "Rmd/AACES analysis/ICC_02282024.rds")
b <- readRDS("/Users/colinccm/Documents/GitHub/Peres/IF_case_ctrl_AACES_NCOCS/Rmd/AACES analysis/ICC_02282024.rds")
b
...
```{r, fig.width=12}
markers_ROI %>% 
  filter(data_version == "AACES_v1_NCOCS") %>% 
  select(
  "tumor_percent_cd3_i", "tumor_percent_cd3plus_cd8plus_i", "tumor_percent_cd3plus_foxp3plus_i", "tumor_percent_cd11b_i", "tumor_percent_cd11bplus_cd15plus_i",
                 "stroma_percent_cd3_i", "stroma_percent_cd3plus_cd8plus_i", "stroma_percent_cd3plus_foxp3plus_i", "stroma_percent_cd11b_i", "stroma_percent_cd11bplus_cd15plus_i",
                 "tumor_percent_cd3_p", "tumor_percent_cd3plus_cd8plus_p", "tumor_percent_cd3plus_foxp3plus_p", "tumor_percent_cd11b_p", "tumor_percent_cd11bplus_cd15plus_p",
...
tbl1 <-
  markers_ROI %>% 
  select(cd3_tumor_cat.i, cd3plus_cd8plus_tumor_cat.i, cd3plus_foxp3plus_tumor_cat.i, 
              cd11b_tumor_cat.i, cd11bplus_cd15plus_tumor_cat.i) %>% 
  rename(cd3_tumor = cd3_tumor_cat.i, cd3plus_cd8plus_tumor = cd3plus_cd8plus_tumor_cat.i,
         cd3plus_foxp3plus_tumor = cd3plus_foxp3plus_tumor_cat.i, 
         cd11b_tumor = cd11b_tumor_cat.i, cd11bplus_cd15plus_tumor = cd11bplus_cd15plus_tumor_cat.i) %>% 
  tbl_summary(
...
tbl2 <-
  markers_ROI %>% 
  select(cd3_stroma_cat.i, cd3plus_cd8plus_stroma_cat.i, cd3plus_foxp3plus_stroma_cat.i, 
              cd11b_stroma_cat.i, cd11bplus_cd15plus_stroma_cat.i) %>% 
  rename(cd3_stroma = cd3_stroma_cat.i, cd3plus_cd8plus_stroma = cd3plus_cd8plus_stroma_cat.i,
         cd3plus_foxp3plus_stroma = cd3plus_foxp3plus_stroma_cat.i, 
cd11b_stroma = cd11b_stroma_cat.i, cd11bplus_cd15plus_stroma = cd11bplus_cd15plus_stroma_cat.i) %>% 
  tbl_summary(
              statistic = list(all_continuous() ~ "{mean} ({sd})"),
...
tbl3 <-
  markers_ROI %>% 
  select(cd3_total_cat.i, cd3plus_cd8plus_total_cat.i, cd3plus_foxp3plus_total_cat.i, 
              cd11b_total_cat.i, cd11bplus_cd15plus_total_cat.i) %>% 
  rename(cd3_total = cd3_total_cat.i, cd3plus_cd8plus_total = cd3plus_cd8plus_total_cat.i,
         cd3plus_foxp3plus_total = cd3plus_foxp3plus_total_cat.i, 
cd11b_total = cd11b_total_cat.i, cd11bplus_cd15plus_total = cd11bplus_cd15plus_total_cat.i) %>% 
  tbl_summary(
              statistic = list(all_continuous() ~ "{mean} ({sd})"),
...
tbl5 <-
  markers_ROI %>% 
  select(cd3_tumor_cat.p, cd3plus_cd8plus_tumor_cat.p, cd3plus_foxp3plus_tumor_cat.p, 
              cd11b_tumor_cat.p, cd11bplus_cd15plus_tumor_cat.p) %>% 
  rename(cd3_tumor = cd3_tumor_cat.p, cd3plus_cd8plus_tumor = cd3plus_cd8plus_tumor_cat.p,
         cd3plus_foxp3plus_tumor = cd3plus_foxp3plus_tumor_cat.p, 
cd11b_tumor = cd11b_tumor_cat.p, cd11bplus_cd15plus_tumor = cd11bplus_cd15plus_tumor_cat.p) %>% 
  tbl_summary(
              statistic = list(all_continuous() ~ "{mean} ({sd})"),
                            label = list(cd3_tumor ~ "percent cd3+", cd3plus_cd8plus_tumor ~ "percent cd3+/cd8+",
                           cd3plus_foxp3plus_tumor ~ "percent cd3+/FoxP3+",
...
tbl6 <-
  markers_ROI %>% 
  select(cd3_stroma_cat.p, cd3plus_cd8plus_stroma_cat.p, cd3plus_foxp3plus_stroma_cat.p, 
              cd11b_stroma_cat.p, cd11bplus_cd15plus_stroma_cat.p) %>% 
  rename(cd3_stroma = cd3_stroma_cat.p, cd3plus_cd8plus_stroma = cd3plus_cd8plus_stroma_cat.p,
         cd3plus_foxp3plus_stroma = cd3plus_foxp3plus_stroma_cat.p, 
cd11b_stroma = cd11b_stroma_cat.p, cd11bplus_cd15plus_stroma = cd11bplus_cd15plus_stroma_cat.p) %>% 
  tbl_summary(
              statistic = list(all_continuous() ~ "{mean} ({sd})"),
                            label = list(cd3_stroma ~ "percent cd3+", cd3plus_cd8plus_stroma ~ "percent cd3+/cd8+",
                           cd3plus_foxp3plus_stroma ~ "percent cd3+/FoxP3+",
...
tbl7 <-
  markers_ROI %>% 
  select(cd3_total_cat.p, cd3plus_cd8plus_total_cat.p, cd3plus_foxp3plus_total_cat.p, 
              cd11b_total_cat.p, cd11bplus_cd15plus_total_cat.p) %>% 
  rename(cd3_total = cd3_total_cat.p, cd3plus_cd8plus_total = cd3plus_cd8plus_total_cat.p,
         cd3plus_foxp3plus_total = cd3plus_foxp3plus_total_cat.p, 
cd11b_total = cd11b_total_cat.p, cd11bplus_cd15plus_total = cd11bplus_cd15plus_total_cat.p) %>% 
  tbl_summary(
              statistic = list(all_continuous() ~ "{mean} ({sd})"),
                            label = list(cd3_total ~ "percent cd3+", cd3plus_cd8plus_total ~ "percent cd3+/cd8+",
                           cd3plus_foxp3plus_total ~ "percent cd3+/FoxP3+",
...
Adjusted by `stage + refage + histotype2`
```{r}
markers_ROI_o <- markers_ROI %>% 
  rename(cd3 = cd3_total_cat.i, cd3plus_cd8plus = cd3plus_cd8plus_total_cat.i,
         cd3plus_foxp3plus = cd3plus_foxp3plus_total_cat.i, 
         cd11b = cd11b_total_cat.i, cd11bplus_cd15plus = cd11bplus_cd15plus_total_cat.i)
  
tbl1 <- coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_o)  %>% 
...
tbl2 <- coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
...
tbl3 <- coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
...
tbl4 <- coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd11b + stage + refage + histotype2, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl5 <- coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2, data =  markers_ROI_o) %>%
  tbl_regression(exponentiate = TRUE,
...
markers_ROI_t <- markers_ROI %>% 
  rename(cd3 = cd3_tumor_cat.i, cd3plus_cd8plus = cd3plus_cd8plus_tumor_cat.i,
         cd3plus_foxp3plus = cd3plus_foxp3plus_tumor_cat.i, 
         cd11b = cd11b_tumor_cat.i, cd11bplus_cd15plus = cd11bplus_cd15plus_tumor_cat.i)
  
tbl1 <- coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_t)  %>% 
  tbl_regression(exponentiate = TRUE,
                 include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_t) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, data =  markers_ROI_t) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl4 <- coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd11b + stage + refage + histotype2, data =  markers_ROI_t) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl5 <- coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2, data =  markers_ROI_t) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
...
markers_ROI_s <- markers_ROI %>% 
  rename(cd3 = cd3_stroma_cat.i, cd3plus_cd8plus = cd3plus_cd8plus_stroma_cat.i,
         cd3plus_foxp3plus = cd3plus_foxp3plus_stroma_cat.i, 
         cd11b = cd11b_stroma_cat.i, cd11bplus_cd15plus = cd11bplus_cd15plus_stroma_cat.i)

tbl1 <- coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_s) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_s) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, data =  markers_ROI_s) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl4 <- coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd11b + stage + refage + histotype2, data =  markers_ROI_s) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl5 <- coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2, data =  markers_ROI_s) %>%
  tbl_regression(exponentiate = TRUE,
                 include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
...
markers_ROI_o <- markers_ROI %>% 
  rename(cd3 = cd3_total_cat.p, cd3plus_cd8plus = cd3plus_cd8plus_total_cat.p,
         cd3plus_foxp3plus = cd3plus_foxp3plus_total_cat.p, 
         cd11b = cd11b_total_cat.p, cd11bplus_cd15plus = cd11bplus_cd15plus_total_cat.p)
...
markers_ROI_t <- markers_ROI %>% 
  rename(cd3 = cd3_tumor_cat.p, cd3plus_cd8plus = cd3plus_cd8plus_tumor_cat.p,
         cd3plus_foxp3plus = cd3plus_foxp3plus_tumor_cat.p, 
         cd11b = cd11b_tumor_cat.p, cd11bplus_cd15plus = cd11bplus_cd15plus_tumor_cat.p)
...
markers_ROI_s <- markers_ROI %>% 
  rename(cd3 = cd3_stroma_cat.p, cd3plus_cd8plus = cd3plus_cd8plus_stroma_cat.p,
         cd3plus_foxp3plus = cd3plus_foxp3plus_stroma_cat.p, 
         cd11b = cd11b_stroma_cat.p, cd11bplus_cd15plus = cd11bplus_cd15plus_stroma_cat.p)
...
coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_o) %>%
  cox.zph()
coxph(Surv(time = markers_ROI_o$timeint_fu, 
                   event = markers_ROI_o$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_o) %>%
...
coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_t) %>%
  cox.zph()
coxph(Surv(time = markers_ROI_t$timeint_fu, 
                   event = markers_ROI_t$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_t) %>%
...
coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd3 + stage + refage + histotype2, data =  markers_ROI_s) %>%
  cox.zph()
coxph(Surv(time = markers_ROI_s$timeint_fu, 
                   event = markers_ROI_s$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2, data =  markers_ROI_s) %>%
...
<!--                    event = markers_ROIclust_o$os_event) ~ cd3 + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_o)  %>%  -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu, -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- #                    event = markers_ROIclust_o$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, id = "suid", data = markers_ROIclust_o, cut=1700, episode='tgroup') -->
<!-- #  -->
<!-- # coxph(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus + cd3plus_foxp3plus:tstop + stage + refage + histotype2, cluster = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # coxph(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage + histotype2, cluster = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # survcheck(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage + histotype2, id = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # survfit(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus + strata(tgroup) + stage + refage + histotype2, cluster = suid, influence = TRUE, -->
<!-- #               data =  newdata) -->
...
<!--                    event = markers_ROIclust_o$os_event) ~ cd11b + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!--                    event = markers_ROIclust_t$os_event) ~ cd3 + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_t)  %>%  -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu, -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- # newdata <- survSplit(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!-- #                    event = markers_ROIclust_t$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, id = "suid", data = markers_ROIclust_t, cut=1700, episode='tgroup')    -->
<!-- #  -->
...
<!--                    event = markers_ROIclust_t$os_event) ~ cd11b + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!--                    event = markers_ROIclust_s$os_event) ~ cd3 + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd3plus_cd8plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu, -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- # newdata <- survSplit(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!-- #                    event = markers_ROIclust_s$os_event) ~ cd3plus_foxp3plus + stage + refage + histotype2, id = "suid", data = markers_ROIclust_s, cut=1700, episode='tgroup')    -->
<!-- #  -->
<!-- # tbl3 <- coxph(Surv(time = newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage + histotype2, cluster = suid,  -->
<!-- #               data =  newdata) %>%  -->
...
<!--                    event = markers_ROIclust_s$os_event) ~ cd11b + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- #                  include = 'cd3plus_foxp3plus:strata(tgroup)') %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl4 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11b + stage + refage + histotype2, cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11bplus_cd15plus + stage + refage + histotype2, cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- tbl1 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd3 + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_o)  %>%  -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd3plus_cd8plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu, -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd3plus_foxp3plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- # newdata <- survSplit(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!-- #                    event = markers_ROIclust_o$os_event) ~ cd3plus_foxp3plus + stage + refage, id = "suid", data = markers_ROIclust_o, cut=1700, episode='tgroup') -->
<!-- #  -->
<!-- # coxph(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus + cd3plus_foxp3plus:tstop + stage + refage, cluster = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # coxph(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage, cluster = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # survcheck(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage, id = suid,  -->
<!-- #               data =  newdata) -->
<!-- #  -->
<!-- # survfit(Surv(newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus + strata(tgroup) + stage + refage, cluster = suid, influence = TRUE, -->
<!-- #               data =  newdata) -->
...
<!-- tbl4 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd11b + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_o$timeint_fu,  -->
<!--                    event = markers_ROIclust_o$os_event) ~ cd11bplus_cd15plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_o) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- tbl1 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd3 + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_t)  %>%  -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd3plus_cd8plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu, -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd3plus_foxp3plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- # newdata <- survSplit(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!-- #                    event = markers_ROIclust_t$os_event) ~ cd3plus_foxp3plus + stage + refage, id = "suid", data = markers_ROIclust_t, cut=1700, episode='tgroup')    -->
<!-- #  -->
<!-- # tbl3 <- coxph(Surv(time = newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage, cluster = suid,  -->
<!-- #               data =  newdata) %>%  -->
...
<!-- #                  include = 'cd3plus_foxp3plus:strata(tgroup)') %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl4 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd11b + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_t$timeint_fu,  -->
<!--                    event = markers_ROIclust_t$os_event) ~ cd11bplus_cd15plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_t) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- tbl1 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd3 + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl2 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd3plus_cd8plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_cd8plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl3 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu, -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd3plus_foxp3plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd3plus_foxp3plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- # newdata <- survSplit(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!-- #                    event = markers_ROIclust_s$os_event) ~ cd3plus_foxp3plus + stage + refage, id = "suid", data = markers_ROIclust_s, cut=1700, episode='tgroup')    -->
<!-- #  -->
<!-- # tbl3 <- coxph(Surv(time = newdata$tstart, newdata$tstop, -->
<!-- #                    event = newdata$event) ~ cd3plus_foxp3plus:strata(tgroup) + stage + refage, cluster = suid,  -->
<!-- #               data =  newdata) %>%  -->
...
<!-- #                  include = 'cd3plus_foxp3plus:strata(tgroup)') %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl4 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11b + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11bplus_cd15plus + stage + refage,  -->
<!--               cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- #                  include = 'cd3plus_foxp3plus:strata(tgroup)') %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl4 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11b + stage + refage, cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11b) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
<!-- tbl5 <- coxph(Surv(time = markers_ROIclust_s$timeint_fu,  -->
<!--                    event = markers_ROIclust_s$os_event) ~ cd11bplus_cd15plus + stage + refage, cluster = suid, data =  markers_ROIclust_s) %>% -->
<!--   tbl_regression(exponentiate = TRUE, -->
<!--                  include = cd11bplus_cd15plus) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level") -->
...
<!-- ## Overall "Surv ~ cd3_total + stage + refage + histotype2, cluster = suid" -->
...
<!-- fit2 <- coxph(Surv(time = timeint_fu, event = os_event) ~ cd3_total + stage + refage + histotype2, cluster = suid, data = clin_surv) -->
...
coxph(Surv(time = markers_ROI$timeint_fu, 
                   event = markers_ROI$os_event) ~ clusters_all_IandP + stage + refage + histotype2, data =  markers_ROI)  %>% 
  tbl_regression(exponentiate = TRUE#,
...
tbl1 <- coxph(Surv(time = markers_ROI$timeint_fu, 
                   event = markers_ROI$os_event) ~ immunoscore_patients + stage + refage + histotype2, data =  markers_ROI)  %>% 
  tbl_regression(exponentiate = TRUE,
...
tbl2 <- coxph(Surv(time = markers_ROI$timeint_fu, 
                   event = markers_ROI$os_event) ~ immunoscore_2018lancet_patients + stage + refage + histotype2, data =  markers_ROI) %>%
  tbl_regression(exponentiate = TRUE,
